// This file is completely independent of any OpenGL artefacts.
// It adds several operators to enum class for easier use as bitflags.
// Thanks @ github/JoJendersie!
