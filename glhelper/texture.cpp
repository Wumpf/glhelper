...
namespace gl
{
	...
	{
		GLHELPER_ASSERT(slotIndex < sizeof(s_boundTextures) / sizeof(Texture*), "Can't bind texture to slot " + std::to_string(slotIndex) +". Maximum number of slots is " + std::to_string(sizeof(s_boundTextures) / sizeof(Texture*)));
